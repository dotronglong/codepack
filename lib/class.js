...
export default class Class {
  ...
  static getMethods(object) {
    if (typeof object.prototype === 'undefined') {
      let prototype = eval(object.constructor.name).prototype
      let methods = this.getMethods(prototype)
      if (typeof object[INSTANCEOF_PROPERTY_NAME] !== 'undefined') {
        object[INSTANCEOF_PROPERTY_NAME].forEach((name) => {
      ...
      return Object.getOwnPropertyNames(object.prototype)
        .concat(Object.getOwnPropertySymbols(object.prototype))
    }
  }
